...
var temp_JSON = {
    ...
    hverfi_8: {
        streets: ["austurgata","fjarðargata","gunnarssund","hverfisgata","linnetsstígur","mjósund","skólabraut","sunnuvegur","tjarnarbraut","urðarstígur",
        ...
        gray_dates: [
            ...
            new Date(2021,9,13),new Date(2021,9,27),new Date(2021,10,10),new Date(2021,10,24),new Date(2021,11,8),new Date(2021,11,22)],
        blue_dates: [
            new Date(2021,0,14),new Date(2021,1,4), new Date(2021,2,4),  new Date(2021,3,8), 
			new Date(2021,3,29),
            new Date(2021,4,24), new Date(2021,5,24), new Date(2021,6,22), new Date(2021,7,19), 
            new Date(2021,8,16),new Date(2021,9,15),new Date(2021,10,11),new Date(2021,11,9)],
        green_dates: [
            new Date(2021,0,14),new Date(2021,0,15),new Date(2021,1,11),new Date(2021,2,11),
            new Date(2021,3,11),new Date(2021,4,15),new Date(2021,5,3),new Date(2021,6,1), new Date(2021,6,29), new Date(2021,7,26),
            new Date(2021,8,23),new Date(2021,9,23),new Date(2021,10,18),new Date(2021,11,16)]
